/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 19b78495982b8d603aff932ff5e20126)
// Runtime types generated with workerd@1.20260107.1 2025-11-17 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		BOT_INFO: {"id":7414779700,"is_bot":true,"first_name":"流典忆庭","username":"yet_another_inline_bot","can_join_groups":true,"can_read_all_group_messages":false,"supports_inline_queries":true,"can_connect_to_business":false,"has_main_web_app":false};
		BOT_TOKEN: string;
		WEB_HOOK: string;
		SECRET_TOKEN: string;
		DB: D1Database;
